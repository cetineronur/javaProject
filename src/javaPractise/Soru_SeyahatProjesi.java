...
public class Soru_SeyahatProjesi {
    public static void main(String[] args) {
        ...
        örn: (100 km yol. Bilet parası  (100/20)* 5 =25 euro
 		...
 		İPUCU:  toplamTutar, işlem, FrankfurtKm, KmBirimFiyat   
		gibi sabit veri tipleri oluşturabilirsiniz. İşlemlerde 
		direkt bunları cağırabilirsiniz.

        todo İLK OLARAK;

        "Nereye yolculuk etmek istiyorsunuz? (Frankfurt : 60 KM          ---        
         Köln : 80 KM ---(20 KM başına 5 euro bilet parası alınmaktadir..)   
		yazısı gelsin.
      ...
      "Rota = Köln" yazdırın.
       ...
       2.  Sistem bize "Kaç kişilik bilet istiyorsunuz? 
       (Max 2 kişilik olabilir):   "   sorusunu sorsun.
